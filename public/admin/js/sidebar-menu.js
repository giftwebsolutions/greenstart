...
if ($('#pageWrapper').hasClass('compact-wrapper')) {
    $('.sidebar-title').append('<div class="according-menu"><i class="bi bi-arrow-right"></i></div>');
    $('.sidebar-title').click(function () {
        $('.sidebar-title').removeClass('active').find('div').replaceWith('<div class="according-menu"><i class="bi bi-arrow-right"></i></div>');
        $('.sidebar-submenu, .menu-content').slideUp('normal');
        $('.menu-content').slideUp('normal');
        if ($(this).next().is(':hidden') == true) {
            $(this).addClass('active');
            $(this).find('div').replaceWith('<div class="according-menu"><i class="bi bi-arrow-down-short"></i></div>');
            $(this).next().slideDown('normal');
        } else {
            $(this).find('div').replaceWith('<div class="according-menu"><i class="bi bi-arrow-right"></i></div>');
        }
    });
    $('.sidebar-submenu, .menu-content').hide();
    $('.submenu-title').append('<div class="according-menu"><i class="bi bi-arrow-right"></i></div>');
    $('.submenu-title').click(function () {
        $('.submenu-title').removeClass('active').find('div').replaceWith('<div class="according-menu"><i class="bi bi-arrow-right"></i></div>');
    ...
    if ((contentwidth) < 992) {
        ...
        $('.submenu-title').click(function () {
            ...
            $('.submenu-title').find('div').replaceWith('<div class="according-menu"><i class="bi bi-arrow-right"></i></div>');
            $('.submenu-content').slideUp('normal');
            if ($(this).next().is(':hidden') == true) {
                $(this).addClass('active');
                $(this).find('div').replaceWith('<div class="according-menu"><i class="bi bi-arrow-down-short"></i></div>');
        ...
        $('.sidebar-title').click(function () {
            ...
            $('.sidebar-title').find('div').replaceWith('<div class="according-menu"><i class="bi bi-arrow-right"></i></div>');
            $('.sidebar-submenu, .menu-content').slideUp('normal');
            if ($(this).next().is(':hidden') == true) {
                $(this).addClass('active');
                $(this).find('div').replaceWith('<div class="according-menu"><i class="bi bi-arrow-down-short"></i></div>');
    ...
    $(".sidebar-wrapper nav ul li a").filter(function () {
        ...
        if (link) {
            if (current.indexOf(link) != -1) {
                ...
                $(this).addClass('active');
                $(this).parent().parent().parent().children('a').find('div').replaceWith('<div class="according-menu"><i class="bi bi-arrow-down-short"></i></div>');
                $(this).parent().parent().parent().parent().parent().children('a').find('div').replaceWith('<div class="according-menu"><i class="bi bi-arrow-down-short"></i></div>');
                return false;
            }
        }
    });
