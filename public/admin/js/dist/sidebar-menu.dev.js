...
if ($('#pageWrapper').hasClass('compact-wrapper')) {
  ...
  jQuery('.sidebar-title').click(function () {
    ...
    if (jQuery(this).next().is(':hidden') == true) {
      ...
      jQuery(this).find('div').replaceWith('<div class="according-menu"><i class="bi bi-arrow-down-short"></i></div>');
      jQuery(this).next().slideDown('normal');
    } else {
      jQuery(this).find('div').replaceWith('<div class="according-menu"><i class="bi bi-arrow-right"></i></div>');
    }
  });
  ...
  jQuery('.submenu-title').click(function () {
    jQuery('.submenu-title').removeClass('active').find('div').replaceWith('<div class="according-menu"><i class="bi bi-arrow-right"></i></div>');
  ...
  if (contentwidth < '992') {
    ...
    jQuery('.submenu-title').click(function () {
      ...
      jQuery('.submenu-title').find('div').replaceWith('<div class="according-menu"><i class="bi bi-arrow-right"></i></div>');
      jQuery('.submenu-content').slideUp('normal');
    ...
    jQuery('.sidebar-title').click(function () {
      ...
      jQuery('.sidebar-title').find('div').replaceWith('<div class="according-menu"><i class="bi bi-arrow-right"></i></div>');
      jQuery('.sidebar-submenu, .menu-content').slideUp('normal');
