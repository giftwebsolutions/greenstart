                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-12">
                                    <input id="title" type="text" placeholder="Title"
                                        ...
                                        value="{{ old('title', $block->title) }}" required autocomplete="title">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-12">
                                    <input id="key" type="text" placeholder="Key"
                                        ...
                                        value="{{ old('key', $block->key) }}" required autocomplete="key" autofocus>
                ...
                <div class="card">
                    ...
                    <div class="card-body p-3">
                        <input id="icon" type="text" placeholder="fa fa-pencil"
                            ...
                            value="{{ old('icon', $block->icon) }}" required autocomplete="icon">
                    ...
                    <div class="card-body p-3">
                        <div class="mb-3">
                            ...
                            <input type="file" class="form-control @error('thumbnail') is-invalid @enderror"
                                name="thumbnail" id ="featured_image" />
                        </div>
                        <div class="mb-3">

                            @if ($block->thumbnail !== null)
                                <img src="{{ asset(Modules\SysAdmin\Helpers\ImageUploader::getFilePath($block->thumbnail, $block->created_at, 'thumbnail')) }}"
