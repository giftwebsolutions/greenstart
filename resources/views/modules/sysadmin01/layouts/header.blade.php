<div class="page-header">
    <div class="header-wrapper row m-0">
        ...
        <div class="header-logo-wrapper col-auto p-0">
            <div class="logo-wrapper"><a href="{{ route('sysadmin.index') }}"><img class="img-fluid"
                ...
                <li class="profile-nav onhover-dropdown pe-0 py-0">
                    <div class="media profile-media"><img class="b-r-10"
                        ...
                        <div class="media-body"><span>{{ auth()->user()->name }}</span>
                            <p class="mb-0 font-roboto"><i class="middle bi bi-arrow-down-short"></i></p>
                        </div>
                    </div>
                    <ul class="profile-dropdown onhover-show-div">
                        <li><a href="{{ route('sysadmin.user.edit', auth()->user()->id) }}"><i
                        ...
                        <li>
                            ...
                            <form id="logout-form" action="{{ route('sysadmin.signout') }}" method="post"
