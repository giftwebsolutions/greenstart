...
@section('content')
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-md-8">
                <div class="card">
                    <form class="theme-form" id="create-category" method="POST" enctype="multipart/form-data"
                        action="{{ route('sysadmin.blog.category.create') }}">
                        @csrf

                        <div class="card-body p-3">
                            <div class="row mb-3">
                                <label for="name" class="col-md-12 col-form-label">{{ __('Category Name') }}</label>
                            ...
                            <div class="row mb-3">
                                <label for="keywords" class="col-md-12 col-form-label">{{ __('Category keywords') }}</label>
...
@pushOnce('scripts')
    ...
    {!! JsValidator::formRequest('Modules\SysAdmin\Requests\BlogCategoryFormRequest', '#create-category') !!}
    <script type="module">
        let file;
