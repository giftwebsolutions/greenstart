...
<div class="container-fluid">
    ...
    <div class="row">
        <div class="col-md-8">
            <div class="card">
                <form class="theme-form" id="create-attribute-type" method="POST"
                      action="{{ route('sysadmin.catalog.attribute.type.store') }}">
                    @csrf
                    ...
                    <div class="card-body p-3">
                        ...
                        <div class="mb-3">
                            ...
                            <input id="type_name" type="text" name="type_name"
                                   ...
                                   placeholder="e.g., Text, Select, Multiselect" required>
                        ...
                        <div class="mb-3">
                            ...
                            <input id="identifier" type="text" name="identifier"
                                   ...
                                   placeholder="e.g., text, select, multiselect">
        ...
        <div class="col-md-4">
            <div class="card">
                ...
                <div class="card-body p-3">
                    @php
                        // prefer pulling from model or repo; fallback here:
                        $statuses = $statuses ?? [0=>'Delete',1=>'Published',2=>'Draft'];
                    @endphp
                    <select class="form-select @error('status') is-invalid @enderror" name="status" form="create-attribute-type" required>
