                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-12">
                                <select class="form-select @error('type') is-invalid @enderror" name="type">
                                    <option value="1" {{ old('type', $product->type) == 1 ? 'selected' : '' }}>Simple</option>
                                    <option value="2" {{ old('type', $product->type) == 2 ? 'selected' : '' }}>Variable</option>
                                </select>
                                @error('type')
                                    <span class="invalid-feedback"><strong>{{ $message }}</strong></span>
                                @enderror
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6 form-check">
                                <input class="form-check-input"
                                       ...
                                       name="slider"
                                       value="1"
                                       {{ old('slider', $product->slider) ? 'checked' : '' }}>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="mt-3">
                                    ...
                                    @else
                                        <img id="thumbPreview" src="" alt="" class="img-fluid d-none">
                                    @endif
                ...
                <div class="card-body p-3">
                    <select class="form-select @error('product_category') is-invalid @enderror"
                        ...
                        @foreach ($categories as $cat)
                            <option value="{{ $cat['id'] }}"
                                {{ (int) old('product_category', $product->product_category) === (int) $cat['id'] ? 'selected' : '' }}>
                                {{ $cat['name'] }}
                            </option>
                        @endforeach
                    </select>
                ...
                <div class="card-body p-3">
                    <select class="form-select @error('sub_product_category') is-invalid @enderror"
                        ...
                        @foreach ($subCategories as $cat)
                            <option value="{{ $cat['id'] }}"
                                {{ (int) old('sub_product_category', $product->sub_product_category) === (int) $cat['id'] ? 'selected' : '' }}>
                                {{ $cat['name'] }}
                            </option>
                        @endforeach
                    </select>
