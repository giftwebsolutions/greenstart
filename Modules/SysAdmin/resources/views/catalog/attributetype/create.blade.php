...
@section('content')
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-md-8">
                <div class="card">
                    <form class="theme-form" id="create-attribute" method="POST" action="{{ route('sysadmin.catalog.attributetype.store') }}">
                        @csrf
                        ...
                        <div class="card-body p-3">
                            ...
                            {{-- Group --}}
                            <div class="row mb-3">
                                <label for="group_id" class="col-md-12 col-form-label">Attribute Type</label>
                                <div class="col-md-12">
