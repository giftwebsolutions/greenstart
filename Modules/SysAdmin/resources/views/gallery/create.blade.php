    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-md-8 offset-md-2">
                <div class="card">
                    <form id="create-gallery" class="theme-form" method="POST" enctype="multipart/form-data"
                          action="{{ route('sysadmin.media.gallery.store') }}">
                        @csrf
                        ...
                        <div class="card-footer text-end">
                            ...
                            <button type="submit" class="btn btn-primary mx-2">Create & Upload Images</button>
                        </div>
                    </form>
                </div>
            </div>
