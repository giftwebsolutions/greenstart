                        ...
                        <div class="single-blog-post blog-grid-post">
                            ...
                            <div class="blog-post-media">
                                <div class="blog-image single-blog">
                                    <img src="{{ $blog->featured_image ? asset($blog->featured_image) : asset('assets/images/blog-image/3.jpg') }}"
                                        alt="{{ $blog->title }}" />
                                </div>
                            </div>
                            ...
                            <div class="blog-post-content-inner mt-30px">
                                ...
                                {{-- if you have short description use it, else show first part of content --}}
                                        ...
                                        <div class="blog-post-content-inner mt-30px">
                                            ...
                                            <ul class="blog-page-meta">
                                                <li><a href="#"><i class="ion-person"></i>
                                                        {{ $rel->author->name ?? 'Admin' }}</a></li>
                                                <li>
                                                    <a href="#"><i class="ion-calendar"></i>
                                                        {{ optional($rel->published_at)->format('d M, Y') ?? optional($rel->created_at)->format('d M, Y') }}
                                                    </a>
                                                </li>
                                            </ul>
                                        </div>
